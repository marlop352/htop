...
static Htop_Reaction Platform_actionSetIOPriority(State* st) {
   ...
   CygwinProcess* p = (CygwinProcess*) Panel_getSelected(panel);
   if (!p) return HTOP_OK;
   ...
   if (set) {
      ...
      bool ok = MainPanel_foreachProcess((MainPanel*)panel, (MainPanel_ForeachProcessFn) CygwinProcess_setIOPriority, (Arg){ .i = ioprio }, NULL);
      if (!ok)
         beep();
   }
...
double Platform_setCPUValues(Meter* this, int cpu) {
   CygwinProcessList* pl = (CygwinProcessList*) this->pl;
